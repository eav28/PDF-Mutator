...
inline u32 rand_next2(afl_state_t *afl) {

  return rand();

}

inline u32 rand_below2(afl_state_t *afl, u32 mod){
...
inline u32 choose_block_len(afl_state_t *afl, u32 limit) {
  ...
  return min_value + rand_below2(afl, MIN(max_value, limit) - min_value + 1);
...
inline u32 afl_mutate(afl_state_t *afl, u8 *buf, u32 len, u32 steps,
  ...
  retry_havoc_step: {
    ...
    u32 r = rand_below2(afl, MUT_STRATEGY_ARRAY_SIZE), item;
    ...
    switch (mutation_array[r]) {
      ...
      case MUT_FLIPBIT: {
        ...
        u8  bit = rand_below2(afl, 8);
        u32 off = rand_below2(afl, len);
        buf[off] ^= 1 << bit;
      ...
      case MUT_INTERESTING8: {
        ...
        item = rand_below2(afl, sizeof(interesting_8));
        buf[rand_below2(afl, len)] = interesting_8[item];
        break;
      ...
      case MUT_INTERESTING16: {
        ...
        item = rand_below2(afl, sizeof(interesting_16) >> 1);
        *(u16 *)(buf + rand_below2(afl, len - 1)) = interesting_16[item];
      ...
      case MUT_INTERESTING16BE: {
        ...
        item = rand_below2(afl, sizeof(interesting_16) >> 1);
        *(u16 *)(buf + rand_below2(afl, len - 1)) = SWAP16(interesting_16[item]);
      ...
      case MUT_INTERESTING32: {
        ...
        item = rand_below2(afl, sizeof(interesting_32) >> 2);
        *(u32 *)(buf + rand_below2(afl, len - 3)) = interesting_32[item];
      ...
      case MUT_INTERESTING32BE: {
        ...
        item = rand_below2(afl, sizeof(interesting_32) >> 2);
        *(u32 *)(buf + rand_below2(afl, len - 3)) = SWAP32(interesting_32[item]);
      ...
      case MUT_ARITH8_: {
        ...
        item = 1 + rand_below2(afl, ARITH_MAX);
        buf[rand_below2(afl, len)] -= item;
        break;
      ...
      case MUT_ARITH16BE_: {
        ...
        u32 pos = rand_below2(afl, len - 1);
        u16 num = 1 + rand_below2(afl, ARITH_MAX);
      ...
      case MUT_ARITH32BE_: {
        ...
        u32 pos = rand_below2(afl, len - 3);
        u32 num = 1 + rand_below2(afl, ARITH_MAX);
      ...
      case MUT_RAND8: {
        ...
        u32 pos = rand_below2(afl, len);
        item = 1 + rand_below2(afl, 255);
        buf[pos] ^= item;
        break;
      ...
      case MUT_CLONE_COPY: {
        ...
        if (likely(len + HAVOC_BLK_XL < max_len)) {
          ...
          u32 clone_from = rand_below2(afl, len - clone_len + 1);
          u32 clone_to = rand_below2(afl, len);
      ...
      case MUT_CLONE_FIXED: {
        ...
        if (likely(len + HAVOC_BLK_XL < max_len)) {
          ...
          u32 clone_to = rand_below2(afl, len);
          u32 strat = rand_below2(afl, 2);
          u32 clone_from = clone_to ? clone_to - 1 : 0;
          item = strat ? rand_below2(afl, 256) : buf[clone_from];
      ...
      case MUT_OVERWRITE_COPY: {
        ...
        u32 copy_from = rand_below2(afl, len - copy_len + 1);
        u32 copy_to = rand_below2(afl, len - copy_len + 1);
      ...
      case MUT_OVERWRITE_FIXED: {
        ...
        item = strat ? rand_below2(afl, 256) : buf[copy_from];
      ...
      case MUT_SWITCH: {
        ...
        switch_from = rand_below2(afl, len);
        do {

          switch_to = rand_below2(afl, len);
      ...
      case MUT_DEL: {
        ...
        u32 del_from = rand_below2(afl, len - del_len + 1);
      ...
      case MUT_SHUFFLE: {
        ...
        u32 off = rand_below2(afl, len - blen + 1);
      ...
      case MUT_ASCIINUM: {
        ...
        u32 off = rand_below2(afl, len), off2 = off, cnt = 0;
        ...
        switch (strat) {
          ...
          case 4:
            if (likely(val && (u64)val < 0x19999999)) {
              ...
              val = (u64)rand_next2(afl) % (u64)((u64)val * 10);

            } else {

              val = rand_below2(afl, 256);
      ...
      case MUT_INSERTASCIINUM: {
        ...
        u32 ins_len = 1 + rand_below2(afl, 8);
        u32 pos = rand_below2(afl, len);
      ...
      case MUT_EXTRA_OVERWRITE: {
        ...
        u32 use_extra = rand_below2(afl, afl->extras_cnt);
        u32 extra_len = afl->extras[use_extra].len;

        if (unlikely(extra_len > len)) { goto retry_havoc_step; }

        u32 insert_at = rand_below2(afl, len - extra_len + 1);
      ...
      case MUT_EXTRA_INSERT: {
        ...
        u32 insert_at = rand_below2(afl, len + 1);
      ...
      case MUT_AUTO_EXTRA_OVERWRITE: {
        ...
        u32 use_extra = rand_below2(afl, afl->a_extras_cnt);
      ...
      case MUT_SPLICE_OVERWRITE: {
        ...
        copy_from = rand_below2(afl, splice_len - copy_len + 1);
        copy_to = rand_below2(afl, len - copy_len + 1);
      ...
      case MUT_SPLICE_INSERT: {
        ...
        clone_from = rand_below2(afl, splice_len - clone_len + 1);
        clone_to = rand_below2(afl, len + 1);
